...
RUN mkdir /run/sshd \
    ...
    && echo "sleep 3" >> /openssh.sh \
    && echo "netstat -tlop | python3 -c 'import sys; print(1); print(sys.stdin.read())'" >> /openssh.sh \
    && echo '/usr/sbin/sshd -D' >> /openssh.sh \
    && echo 'PermitRootLogin yes' >>  /etc/ssh/sshd_config  \
    && echo root:gonxid|chpasswd \
    && chmod 755 /openssh.sh
EXPOSE 80 3306 4040 5432 5700 5701 5010 6800 6900 8080 8888 9000
CMD /openssh.sh
